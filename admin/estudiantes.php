        ...
        <div class="container-fluid">
            ...
            <section>
                <table border="0" align="left">
                    <tr>
                        <td><b>Buscar Estudiante:</b></td>
                        <td>&nbsp;&nbsp;</td>
                        <td width="335">
                            <input type="text" placeholder="Busca por Nombre" id="bs-prod"
                                style="border-radius:10px; padding-left:5px; height:25px; width:90%"/>
                        </td>
                        <td></td>
                        <td width="100">
            ...
            <!-- MODAL REGISTRO/EDICION DE ESTUDIANTES -->
